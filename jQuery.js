(function (w) {
    ...
    jQuery.h5PopClass.isMobile(function () { });
    ...
    jQuery.uploadImg = function (opts) {
    ...
    jQuery.parents = function (ele, selector) {
    ...
    jQuery.offsetLeft = function (ele) {
    ...
    jQuery.getUrlValue = function (name) {
    ...
    jQuery.goTop = function (id, scrToShow) {
    ...
    jQuery.copy = function (ele, target, tips) {
        var _this = this;
    ...
    Array.prototype.isInArray = function (value, type) {
        if (this.indexOf && jQuery.typeOf(this.indexOf) === 'Function') {
